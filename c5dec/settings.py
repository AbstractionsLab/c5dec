...
C5DEC_PARAMS_FILE_PATH = os.path.join(ASSETS_FOLDER_NAME, C5DEC_PARAMS_FILE_NAME)
...
TSHFORMAT_JSON_FILE_PATH = os.path.join(ASSETS_FOLDER_NAME, TSH_PARAMS_FOLDER_NAME, TSH_FORMAT_FILE_NAME)
