...
level: 1.3
links:
- TCS-066: 9poic-LRWg4yY8gHQqi9ttDlKmt39QgA952HNj8sV-s=
normative: true
...
release: stable
release-version: '1.0'
reviewed: z0pvlU2CUao91gwSkRzy4-osD68B7QlFkps6pQZHyqA=
source_prefix: TRS
source_uid: TRS-003
...
- ?c5-defect-0: the output list corresponds to the expected outcome described in TCS-066

**Test case step 5**: Get a list of the available quantum-safe KEM algorithms

- ?c5-defect-0: the list of the available quantum-safe KEM algorithms corresponds to the expected outcome described in TCS-066
