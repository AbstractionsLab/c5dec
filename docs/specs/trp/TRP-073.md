...
level: 1.1
links:
- TCS-064: eFOrUkwxdwnBwNB0y1VFTZ9plFEK1_w0YEPD1cPpUvU=
normative: true
...
release: stable
release-version: '1.0'
reviewed: hRVnTtKaJgQbnw8wFOJqc9mIrG1wtT9PsSbf4Y-_WYA=
source_prefix: TRS
source_uid: TRS-001
...
- ?c5-defect-0: a terminal and a poetry shell were manually created. The expected outcome is in alignment with the expected outcome shown in TCS-064.
