...
derived: false
expected_outcome: |
  Upon selection of an item, the subsequent dropdown list is updated automatically as described in the test steps.
level: '3.29'
links: []
normative: true
...
ref: ''
release: beta
reviewed: LSixyjb6izT7FjMDOpokax5YdQoXnWU3q9umvDx4EAw=
source_prefix: TST
source_uid: TST-038
success_criteria: |
...
# Browse the CC database in the GUI
